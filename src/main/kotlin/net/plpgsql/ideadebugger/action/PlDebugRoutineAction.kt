...
//    private var watcher = ApplicationManager.getApplication().getService(DebugWatcher::class.java)
...
//        val watcher = ApplicationManager.getApplication().getService(DebugWatcher::class.java)
//
